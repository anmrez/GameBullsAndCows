  ...
  methods:{
    ...
    editStatusMenu ( ) {
      ...
      if ( leftMenu === '0px' ) {
        ...
        menu.style.left = -menuWidth - 2 + 'px'
...
<template>
  ...
  <section>
    ...
    <section id="menu" class="w-[25%] h-[100vh] bg-blackOpacity-75 border-r-2 border-white ease-in duration-300 translate-y-[-50%] top-[50%] left-[-25%] absolute z-10">

      <section id="menuBar" @click="editStatusMenu" class="w-[60px] h-[80px] cursor-pointer translate-y-[-50%] top-[50%] translate-x-[100%] right-[0px] absolute overflow-hidden ease-in duration-200 z-20">
